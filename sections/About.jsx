...
function About() {
	return (
		<div className=' h-[615px] bg-offWhite w-full'>
				...
				<section className='h-[615px] flex flex-col container mx-auto items-center relative'>
					...
					<div className='flex flex-col h-52 justify-between'>
						...
						<p className='text-body leading-5 tracking-wide text-justify'>
							...
							<strong className='font-ubuntubold'>Teach Programming</strong> on
							my YouTube channel. Since November 2021, I’ve made tons of
							Projects, including:
						</p>
					</div>
